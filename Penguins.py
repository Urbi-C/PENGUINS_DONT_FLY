...
font = pygame.font.Font('Terserah.ttf', 24)
huge_font = pygame.font.Font('Terserah.ttf', 48)
pygame.display.set_caption('Penguins Cannot Fly!!')
...
player_x = 240
player_y = 40
penguin = pygame.transform.scale(pygame.image.load('penguin.png'),(50,50))
direction = -1
y_speed = 0
gravity = 0.2
x_speed = 3
...
wee = pygame.mixer.Sound('wee.mp3')
...
def move_enemies(enemy_list, current_score):
    enemy_speed = 4 + current_score // 15
    for j in range(len(enemy_list)):
        if enemy_list[j][2] == 1:
...
while run:
    ...
    if game_over:
        ...
        screen.blit(end_text, (60,20))
        screen.blit(end_text2, (70,80))
        player_y = -300
        y_speed = 0
